  ...
  <div class="about">
    <body>
      ...
      <p>
        ...
        onto their trash any longer than necessary. From this pain point,
        Rubbish Radar emerged an innovative platform that maps trash can
        locations from user-generated input, bridging the gap between waste and
      ...
      <p>
        ...
        cities and natural spaces cleaner and more enjoyable for all.
      </p>
      ...
      <p>
        ...
        trash cans, we are actively taking steps to reduce litter and promote
        responsible waste disposal. Every trash can we locate serves as a
        reminder of our dedication to safeguarding the environment for current
        and future generations. By encouraging proper waste management, we
        believe that even the smallest actions can create a significant and
      ...
      <ul>
        <li class="aboutUs">
          To create a global community-driven platform where every disposed of
          item finds its way to a garbage disposal promoting easy accessibility
          to our users.
        </li>
        <li class="aboutUs">
          User-Friendly Interface: Our web application is designed for
          simplicity and ease of use, ensuring that you find the nearest trash
          bin in seconds.
        </li>
        <li class="aboutUs">
      ...
      <ul>
        ...
        <li class="aboutUs">
          Provide Feedback: We're always looking to improve. Share your
          suggestions, experiences, and ideas with us.
        </li>
      </ul>
